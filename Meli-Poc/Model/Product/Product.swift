...
struct Product: Codable {
    ...
    init(id: String, title: String, price: Double, currency_id: String, category_id: String, thumbnail: String, address: Address, shipping: Shipping) {
        self.id = id
        self.title = title
        self.price = price
...
struct ProductResult: Codable {
    ...
    init(query: String, results: [Product]) {
        self.query = query
